...
# Making custom CV sets. Uncomment below to check score for RF model.
...
# Hyperopt setup below to search for optimized RF hyperparameters.
...
# Define function, RF algo, to be optimized.
def f(params):
...
best = fmin(fn=f, space=space_rf, trials=trials, algo=tpe.suggest, max_evals=100)
print "Best: ", best
