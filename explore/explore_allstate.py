...
if __name__ == '__main__':
    ...
    # (1) See the data first to get a feel. Seems like Test data is lacking 1 last col 'loss'
    print train.head(10)
    ...
    # (2) Visualizing training set Loss(Output) vs ID
    ...
    # (3) Checking the skewness of the data
    ...
    # (4) Visualize all histogram of all continusou features
    ...
    # (5) Calculate Pearson correlation btwn all continuous features
    # We see some features are highly correlated, i.e. cont1 & cont9
    correlation_mat = train[cont_features].corr()
    print correlation_mat


    # (6) Comparing training set and test set. See if they are distributed the same way
    ...
    # (7) Recreate training and test set
    ...
    plt.title('PCA analysis of train/test set')
